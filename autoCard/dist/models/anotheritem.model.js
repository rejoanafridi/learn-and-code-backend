...
const anotheritemSchemaDefinition = {};
...
// }
const anotheritemSchema = new mongoose_1.Schema(anotheritemSchemaDefinition, {
    timestamps: true, // Automatically add createdAt and updatedAt
});
// Example of an index (can be made dynamic based on user input later)
// anotheritemSchema.index({ name: 'text' }); 
exports.default = mongoose_1.default.model('Anotheritem', anotheritemSchema);
//# sourceMappingURL=anotheritem.model.js.map